...
def main():
    warnings.warn('m6anet-compute_norm_factors is deprecated and going to be removed in the next release. Please use m6anet compute_norm_factors instead', DeprecationWarning, stacklevel=2)
